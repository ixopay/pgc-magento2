...
namespace Pgc\Client;

use Pgc\Client\CustomerProfile\CustomerData;
use Pgc\Client\CustomerProfile\DeleteProfileResponse;
use Pgc\Client\CustomerProfile\GetProfileResponse;
use Pgc\Client\CustomerProfile\PaymentInstrument;
use Pgc\Client\CustomerProfile\UpdateProfileResponse;
use Pgc\Client\Json\ErrorResponse;
use Pgc\Client\Exception\RateLimitException;
use Pgc\Client\Schedule\ScheduleData;
use Pgc\Client\Exception\ClientException;
use Pgc\Client\Exception\InvalidValueException;
use Pgc\Client\Exception\TimeoutException;
use Pgc\Client\Http\CurlClient;
use Pgc\Client\Http\Response;
use Pgc\Client\StatusApi\StatusRequestData;
use Pgc\Client\Transaction\Base\AbstractTransaction;
use Pgc\Client\Transaction\Capture;
use Pgc\Client\Transaction\Debit;
use Pgc\Client\Transaction\Deregister;
use Pgc\Client\Transaction\Payout;
use Pgc\Client\Transaction\Preauthorize;
use Pgc\Client\Transaction\Refund;
use Pgc\Client\Transaction\Register;
use Pgc\Client\Transaction\Result;
use Pgc\Client\Transaction\VoidTransaction;
use Pgc\Client\Xml\Generator;
use Pgc\Client\Xml\Parser;
...
class Client {
     ...
     *
     * @param \Pgc\Client\Transaction\VoidTransaction $transactionData
     *
     * @return Result
     * @throws ClientException
     * @throws InvalidValueException
