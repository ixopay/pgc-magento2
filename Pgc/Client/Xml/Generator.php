...
use Pgc\Client\Data\CreditCardCustomer;
use Pgc\Client\Data\Customer;
use Pgc\Client\Data\IbanCustomer;
use Pgc\Client\Data\Request;
use Pgc\Client\Exception\InvalidValueException;
use Pgc\Client\Schedule\ScheduleData;
use Pgc\Client\Exception\TypeException;
...
class Generator {
    ...
    /**
     * @param \Pgc\Client\Transaction\VoidTransaction $transaction
     * @param $method
     *
     * @return \DOMElement
     */
