...
namespace Pgc\Client\Xml;

use Pgc\Client\Callback\ChargebackData;
use Pgc\Client\Callback\ChargebackReversalData;
use Pgc\Client\Data\Customer;
use Pgc\Client\Data\Result\CreditcardData;
use Pgc\Client\Data\Result\IbanData;
use Pgc\Client\Data\Result\PhoneData;
use Pgc\Client\Data\Result\ResultData;
use Pgc\Client\Data\Result\WalletData;
use Pgc\Client\Exception\ClientException;
use Pgc\Client\Schedule\ScheduleResult;
use Pgc\Client\Exception\InvalidValueException;
use Pgc\Client\Schedule\ScheduleError;
use Pgc\Client\StatusApi\StatusResult;
use Pgc\Client\Transaction\Error;
use Pgc\Client\Transaction\Result;
use Pgc\Client\Callback\Result as CallbackResult;

/**
 * Class Parser
 *
 * @package Pgc\Client\Xml
 */
class Parser {
